...
router.post('/profile/upload-avatar', auth.mustBeLoggedIn, fileUploader.photoUpload.single('image'), userController.uploadAvatar) // Postman -> Body -> form-data -> key: image -> file
